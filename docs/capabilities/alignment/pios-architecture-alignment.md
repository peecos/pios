...
| Evaluate an outward access request | directly aligned | proposed | not established | eligible authorization/enforcement capability | attributable allow/deny decision and audit evidence | implementation-dependent |
