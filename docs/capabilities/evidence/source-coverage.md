...
| A2 — notes and profiles | `notes-pillar.md`, `profile-pillar.md`, and `profile-app.md` read | Knowledge §14 and profile/context guidance read | profile and note-linking specifications assessed for requirements; implementation trace pending | statement and boundary pass complete; four CRDs drafted |
